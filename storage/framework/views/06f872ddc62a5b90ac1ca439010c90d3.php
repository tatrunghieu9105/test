<?php $__env->startSection('title', 'Đặt vé thành công'); ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 bg-green-500/10 border border-green-500/30 rounded-xl p-4 backdrop-blur-sm success-animation">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-green-300"><?php echo e(session('success')); ?></h3>
                </div>
            </div>
        </div>
        <?php endif; ?>
            ...
            <div class="p-6 md:p-8">
                ...
                <div class="bg-gray-700/50 rounded-xl p-6 mb-8 border border-gray-600/30">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="font-mono text-yellow-400">#<?php echo e($order_code); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-400 mb-1">Ngày đặt</p>
                            <p class="text-white"><?php echo e(now()->format('d/m/Y H:i')); ?></p>
                        </div>
                        <div>
                            ...
                            <div class="flex items-center">
                                ...
                                <?php endif; ?>
                                <span class="font-medium"><?php echo e($payment_method); ?></span>
                            </div>
                        </div>
                        <div>
                            <p class="text-sm text-gray-400 mb-1">Tổng tiền</p>
                            <p class="text-2xl font-bold text-green-400"><?php echo e(number_format($amount)); ?> VNĐ</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-4">
                                <div class="flex-shrink-0">
                                    <div class="w-16 h-24 bg-gray-600 rounded-lg overflow-hidden">
                                        <?php if($ticket->showtime->movie->poster_url): ?>
                                        <img src="<?php echo e($ticket->showtime->movie->poster_url); ?>" alt="<?php echo e($ticket->showtime->movie->title); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                                ...
                                <div class="flex-1">
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                                        <h4 class="text-lg font-bold text-white"><?php echo e($ticket->showtime->movie->title); ?></h4>
                                    ...
                                    <div class="mt-2 grid grid-cols-2 gap-2 text-sm">
                                        <div>
                                            ...
                                            <p class="text-white"><?php echo e($ticket->showtime->start_time->format('d/m/Y')); ?></p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-white">Phòng <?php echo e($ticket->showtime->room->name); ?></p>
                                        </div>
                                        <div>
                                            <p class="text-gray-400">Ghế</p>
                                            <p class="text-white">Ghế <?php echo e($ticket->seat->seat_number); ?></p>
                                        </div>
                                        <div class="col-span-2">
                                            <p class="text-gray-400">Giá vé</p>
                                            <p class="text-yellow-400 font-medium"><?php echo e(number_format($ticket->price)); ?> VNĐ</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 mt-10">
                    <a href="<?php echo e(route('me.orders')); ?>" class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-medium rounded-lg transition-all duration-200 transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        📋
                        Xem vé của tôi
                    </a>
                    <a href="<?php echo e(route('movies.index')); ?>" class="inline-flex items-center justify-center px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-medium rounded-lg transition-all duration-200 transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        🏠
                        Về trang chủ
                    </a>
                </div>
...
<?php echo $__env->make('client.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\datn-cinema\resources\views/client/payments/success.blade.php ENDPATH**/ ?>