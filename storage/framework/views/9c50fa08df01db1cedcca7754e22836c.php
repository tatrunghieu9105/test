...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'Bảng điều khiển'); ?></title>
...
<div class="layout">
  ...
  <main class="content">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
      <h2 style="margin:0"><?php echo $__env->yieldContent('page_title', 'Bảng điều khiển'); ?></h2>
      <div class="actions">
...
<?php /**PATH C:\Users\Admin\datn-cinema\resources\views/admin/layout.blade.php ENDPATH**/ ?>